 ...
 * @author ASUS
 */
@WebServlet(name = "ShowStudentProfileServlet", urlPatterns = {"/ShowStudentProfileServlet"})
public class ShowStudentProfileServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = prop.getProperty(MyApplicationConstants.ShowStudentProfileFeature.LOGIN_PAGE);
        try {
            ...
            if (session != null) {
                ...
                if (account != null) {
                    ...
                    //get student profile
                    String studentCode = MyApplicationHelper.getStudentCode(account.getEmail());
            ...
            log("ShowStudentProfileServlet_NamingException" + ex.getMessage());
        } catch (SQLException ex) {
            log("ShowStudentProfileServlet_SQLException" + ex.getMessage());
        } finally {
